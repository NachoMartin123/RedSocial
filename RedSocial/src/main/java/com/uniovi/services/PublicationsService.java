...
/**
 * Clase que define la lógica de negocio de la aplicacion relacionada
 * con las publicaciones de los usuairos
 * 
...
public class PublicationsService {
	...
	/**
	 * Metodo que obtiene una lista paginada publicaciones de un usario haciendo uso del repositorio
	 * publicationsRepository
	 * @param pageable
	 * @param user
	 * @return
	...
	/**
	 * Metodo que devuelve la lista paginada de todas las publicaciones
	 * haciendo uso del repositorio publicationsRepository
	 * @param pageable
	 * @return
	 */
