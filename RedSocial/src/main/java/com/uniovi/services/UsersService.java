...
/**
 * Clase que define la lógica de negocio de la aplicacion realcionada con los
 * usuarios
 * 
...
public class UsersService {
	...
	/**
	 * Metodo que devuelve una lista paginada de todos los usuairos de la
	 * aplicacion haciendo uso del respositorio usersRepository
	 * 
	 * @param pageable
	 * @return
	 */
	...
	/**
	 * Metodo que permite añadir un usuario con su contraseña encriptada a la
	 * aplicacion haciendo uso del repositorio usersRepository
	 * 
	 * @param user
	 */
	...
	/**
	 * Metodo que devuelve una lista paginada de usuarios en funcion de la
	 ...
	 * @return
	 */
	public Page<User> searchUsersByNameForUser(Pageable pageable,
	...
	/**
	 * Metodo que devuelve un usuario haciendo uso del respositorio
	 * usersRepository
	 * 
	 * @param id
	 *            del usuairo a buscar
	 * @return
	 */
