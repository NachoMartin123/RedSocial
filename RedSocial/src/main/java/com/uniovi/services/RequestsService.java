...
public class RequestsService {
	...
	//// Cada vez que visitamos los detalles de una nota /getMark(Long id) vamos
	// a almacenar la
	//// información de la nota en sesión
	// Set<Request> consultedList = (Set<Request>)
	...
	// httpSession.setAttribute("consultedList", consultedList);//la volvemos a
	// guardar en sesion
	...
	public Page<Request> getRequestsForUser(Pageable pageable,
			User userEnSesion) {
		Page<Request> requests = requestsRepository
				.findRequestForTarget(pageable, userEnSesion);
		return requests;
	}
